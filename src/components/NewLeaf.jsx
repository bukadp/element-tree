...
function NewLeaf(props) {
    ...
    const handleCloseCaret = (parentId) => {
        setOpenCaret(false)
        setOpen(false)
    };

    const addElement = (id, depth) => {
        setBranchId(id);
        setShow(true);
        setBranchDepth(depth)
    }
        ...
        <div className="px-3">
                    ...
                    {props.branch.childNodes.length > 0
                        ? openCaret
                            ? <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#0d6efd"
                                   ...
                                   aria-expanded={open}
                                   onClick={() => {
                                       handleCloseCaret(props.branch.id)
                                   }}>
                                <path
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Name the element</Modal.Title>
                </Modal.Header>
                <Modal.Body>
            ...
            <Collapse in={open}>
                <div>
                    <TreeList branches={props.branch.childNodes}
